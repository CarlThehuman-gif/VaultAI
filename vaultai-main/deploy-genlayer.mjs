...
const DASHBOARD_ENV = './vaultai-dashboard/.env.local';
...
async function deploy() {
  console.log("🚀 Deploying updated vaultai_intelligent_contract.py to GenLayer...");
  
  const code = fs.readFileSync('vaultai_intelligent_contract.py', 'utf8');
  ...
  try {
    ...
    const CONFIG_PATH = './vaultai-dashboard/src/app/config.js';

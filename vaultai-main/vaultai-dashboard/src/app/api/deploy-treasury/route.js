 ...
 *
 * Deploys a VaultAIDemo contract on Arc Testnet for the given wallet.
 ...
 *   3. Deploy VaultAIDemo(owner=userWallet, relayer=backendWallet)
...
import artifact     from '@/contracts/VaultAI.json';

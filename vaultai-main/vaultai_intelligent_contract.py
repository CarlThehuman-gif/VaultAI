...
class VaultAIIntelligentContract(gl.Contract):
    owner: Address
    ...
    def __init__(self, risk_tolerance_pct: u256 = 70, speed_limit: u256 = 25, protection_slippage: u256 = 200):
        self.owner = gl.message.sender_address
        self.treasury_address = gl.message.sender_address
        self.risk_tolerance_pct = risk_tolerance_pct
        self.speed_limit = speed_limit
        self.protection_slippage = protection_slippage
    ...
    @gl.public.write
    def update_constitution(self, risk_tolerance_pct: u256, speed_limit: u256, protection_slippage: u256):
...
"""
        ...
        try:
            ...
            if authorize_trade:
                arc_contract = VaultAI(self.treasury_address)
    ...
    def heartbeat_for(self, treasury_address: Address) -> str:
        ...
        to the user's VaultAIDemo contract. This keeps self.treasury_address

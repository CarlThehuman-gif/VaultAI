 ...
 *   4. Deploys VaultAI (with real constructor args)
 *   5. Mints 1000 WETH into the VaultAI (simulates DAO holdings)
...
async function main() {
  ...
  console.log("\n🚀 VAULTAI Full Testnet Deployment");
  console.log("══════════════════════════════════════════");
  ...
  // ── Step 4: Deploy VaultAI ───────────────────────────────────────
  process.stdout.write("4/6  Deploying VaultAI   ... ");
  const Treasury = await hre.ethers.getContractFactory("VaultAI");

 ...
 *   - vaultai-dashboard/.env.local  (ARC_PRIVATE_KEY for the backend relayer)
 *
 * Run:
...
async function main() {
  ...
  console.log(`\n✓  Written to  vaultai-dashboard/.env.local`);

...
/**
 * @title  VaultAIDemo
 * @notice Lightweight demo contract deployed per-user for the VAULTAI live demo.
...
contract VaultAIDemo {
    ...
    /**
     * @notice Called by the VAULTAI backend relayer after GenLayer AI consensus.
     *
